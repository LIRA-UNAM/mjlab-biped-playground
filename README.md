...
|-------|-------|------------------|
| **Booster T1** | ✅ `asset_zoo/robots/booster_t1` | `Pumas-Getup-Flat-Booster-T1`, `Pumas-Velocity-Flat-Booster-T1-PPO`, `Pumas-Velocity-Rough-Booster-T1-PPO`, `Pumas-Velocity-Flat-Booster-T1-FlashSAC`, `Pumas-Velocity-Rough-Booster-T1-FlashSAC` |
| **Booster K1** | ✅ `asset_zoo/robots/k1` | `Pumas-Getup-Flat-Booster-K1`, `Pumas-Velocity-Flat-Booster-K1-PPO`, `Pumas-Velocity-Rough-Booster-K1-PPO`, `Pumas-Velocity-Flat-Booster-K1-FlashSAC`, `Pumas-Velocity-Rough-Booster-K1-FlashSAC` |
| **Unitree G1** | ✅ `asset_zoo/robots/unitree_g1` | `Pumas-Getup-Flat-Unitree-G1` |
| **Booster T2** | ✅ `asset_zoo/robots/booster_t2` | `Pumas-Getup-Flat-Booster-T2` |
| **Asimov** | ✅ `asset_zoo/robots/asimov` | `Pumas-Velocity-Flat-Asimov`, `Pumas-Velocity-Rough-Asimov` |
...
| Task ID | Robot |
|---------|-------|
| `Pumas-Getup-Flat-Booster-T1` | Booster T1 |
| `Pumas-Getup-Flat-Booster-K1` | Booster K1 |
| `Pumas-Getup-Flat-Unitree-G1` | Unitree G1 |
| `Pumas-Getup-Flat-Booster-T2` | Booster T2 |
...
|---------|-------|-----------|
| `Pumas-Velocity-Flat-Booster-T1-PPO` | Booster T1 | PPO |
| `Pumas-Velocity-Rough-Booster-T1-PPO` | Booster T1 | PPO |
| `Pumas-Velocity-Flat-Booster-T1-FlashSAC` | Booster T1 | FlashSAC |
| `Pumas-Velocity-Rough-Booster-T1-FlashSAC` | Booster T1 | FlashSAC |
| `Pumas-Velocity-Flat-Booster-K1-PPO` | Booster K1 | PPO |
| `Pumas-Velocity-Rough-Booster-K1-PPO` | Booster K1 | PPO |
| `Pumas-Velocity-Flat-Booster-K1-FlashSAC` | Booster K1 | FlashSAC |
| `Pumas-Velocity-Rough-Booster-K1-FlashSAC` | Booster K1 | FlashSAC |
| `Pumas-Velocity-Flat-Asimov` | Asimov | PPO |
| `Pumas-Velocity-Rough-Asimov` | Asimov | PPO |
...
Each K1 velocity task also has opt-in variants, registered for both `Flat` and `Rough` terrain (e.g. `Pumas-Velocity-Flat-Booster-K1-PPO-DA`):
...
|-----|-------|--------------|
| <img src="docs/static/t1_getup.gif" width="400"/><br/>**Pumas-Getup-Flat-Booster-T1** | Booster T1 recovers from a fallen pose and stands back up on flat terrain. | `uv run play Pumas-Getup-Flat-Booster-T1 --wandb-run-path /path/to/my/wandb` |
| <img src="docs/static/g1_getup.gif" width="400"/><br/>**Pumas-Getup-Flat-Unitree-G1** | Unitree G1 recovers from a fallen pose and stands back up on flat terrain. | `uv run play Pumas-Getup-Flat-Unitree-G1 --wandb-run-path /path/to/my/wandb` |
| <img src="docs/static/t2_getup.gif" width="400"/><br/>**Pumas-Getup-Flat-Booster-T2** | Booster T2 recovers from a fallen pose and stands back up on flat terrain. | `uv run play Pumas-Getup-Flat-Booster-T2 --wandb-run-path /path/to/my/wandb` |

### Velocity Tasks
| GIF | Description | Play Command |
|-----|-------|--------------|
| <img src="docs/static/t1_vel.gif" width="400"/><br/>**Pumas-Velocity-Flat-Booster-T1-PPO** | Booster T1 tracks commanded velocity on flat terrain (PPO). | `uv run play Pumas-Velocity-Flat-Booster-T1-PPO --wandb-run-path /path/to/my/wandb` |
| <img src="docs/static/asimov.gif" width="400"/><br/>**Pumas-Velocity-Flat-Asimov** | Asimov tracks commanded velocity on flat terrain. | `uv run play Pumas-Velocity-Flat-Asimov --wandb-run-path /path/to/my/wandb` |
...
```bash
uv run train Pumas-Getup-Flat-Booster-T1 --env.scene.num-envs 4096
# or
uv run train Pumas-Getup-Flat-Booster-K1 --env.scene.num-envs 4096
# or
uv run train Pumas-Getup-Flat-Unitree-G1 --env.scene.num-envs 4096
# or
uv run train Pumas-Getup-Flat-Booster-T2 --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Flat-Booster-T1-PPO --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Rough-Booster-T1-PPO --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Flat-Booster-T1-FlashSAC --env.scene.num_envs 1024
# or
uv run train Pumas-Velocity-Rough-Booster-T1-FlashSAC --env.scene.num_envs 1024
# or
uv run train Pumas-Velocity-Flat-Booster-K1-PPO --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Rough-Booster-K1-PPO --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Flat-Booster-K1-FlashSAC --env.scene.num_envs 1024
# or
uv run train Pumas-Velocity-Rough-Booster-K1-FlashSAC --env.scene.num_envs 1024
# or
uv run train Pumas-Velocity-Flat-Asimov --env.scene.num-envs 4096
# or
uv run train Pumas-Velocity-Rough-Asimov --env.scene.num-envs 4096
```

### Evaluate Policy

```bash
uv run play Pumas-Getup-Flat-Booster-T1 --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Getup-Flat-Booster-K1 --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Getup-Flat-Unitree-G1 --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Getup-Flat-Booster-T2 --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Flat-Booster-T1-PPO --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Rough-Booster-T1-PPO --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Flat-Booster-T1-FlashSAC --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Rough-Booster-T1-FlashSAC --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Flat-Booster-K1-PPO --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Rough-Booster-K1-PPO --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Flat-Booster-K1-FlashSAC --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Rough-Booster-K1-FlashSAC --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Flat-Asimov --wandb-run-path /path/to/my/wandb
# or
uv run play Pumas-Velocity-Rough-Asimov --wandb-run-path /path/to/my/wandb
```
...
uv run python export_policy.py Pumas-Velocity-Flat-Asimov \
  --wandb-run-path <entity>/<project>/<run_id> \
